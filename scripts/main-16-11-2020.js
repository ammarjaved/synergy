            ...
            success: function callback(data) {
                ...
                if(data.features.length==0){
                    ...
                    if(layer=='customer'){
                        ...
                        L.geoJson({ "type": "Point", "coordinates": [data.features[0].properties.x, data.features[0].properties.y] }).addTo(map);
                        ...
                        L.geoJson({ "type": "Point", "coordinates": [data.features[0].geometry.coordinates[0], data.features[0].geometry.coordinates[1]] }).addTo(map);
...
function deleteMe(lyr,dp){
    ...
    $.ajax({
        url:'services/delete.php?p_id='+pid+'&dp='+dp,
        type:'POST',
        success:function(response){
            $("#draggable").show();
